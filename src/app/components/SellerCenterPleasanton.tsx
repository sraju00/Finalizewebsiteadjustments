        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Why didn't my home sell in Pleasanton?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Most homes in Pleasanton don't fail outright. Buyers often hesitate at the monthly payment, compare alternatives, and wait for clearer value before committing."
                }
              },
              {
                "@type": "Question",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Market analysis tools and insights for Pleasanton homeowners
            </p>
          </div>
          ...
          <div className="mb-12 bg-gray-50 border border-gray-200 rounded-lg p-6">
            ...
            <input
              ...
              placeholder="e.g., 789 Main St, Pleasanton"
          ...
          <div className="mb-16 bg-blue-50 border border-blue-200 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-3">
              Request Your Pleasanton Seller Audit
            </h2>
            <p className="text-gray-700 mb-6">
              Get a data-backed analysis of why your home hasn't sold and what actually changes buyer behavior in Pleasanton.
            </p>
            <button
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Page 1 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/why-didnt-my-home-sell')}
              ...
              {/* Page 2 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/skipping-vs-rejection')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
              ...
              {/* Page 5 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/relist-or-wait')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
                <RefreshCw className="w-8 h-8 text-gray-700 mb-4" />
                <h3 className="font-bold text-gray-900 mb-2">Relist or Wait?</h3>
                <p className="text-sm text-gray-600">
                  What usually happens in Pleasanton.
                </p>
              </button>

              {/* Page 6 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/which-price-ranges-moving')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
              ...
              {/* Page 7 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/selective-buyer-market')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
              ...
              {/* Page 8 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/how-long-is-too-long')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
              ...
              {/* Page 9 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/why-price-reductions-dont-work')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
              ...
              {/* Page 10 */}
              <button
                onClick={() => navigate('/seller-center/pleasanton/dead-zone-pricing')}
                className="bg-white border border-gray-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all text-left"
              >
