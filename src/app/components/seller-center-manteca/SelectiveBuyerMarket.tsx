    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
          What Does a "Selective Buyer Market" Mean in Manteca?
        </h1>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              ...
              but only a limited number of homes meet their expectations.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Higher payments increase caution.<br />
              Buyers slow down and avoid uncertainty.
            </p>
          </div>
        </div>
