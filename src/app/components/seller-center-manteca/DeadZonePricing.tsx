    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
          Why Manteca Buyers Pause Instead of Making an Offer (2026)
        </h1>
        ...
        {/* SECTION 2 — WHAT THE DEAD ZONE ACTUALLY IS */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Buyers Are Selective Right Now</h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              In every market, buyers have natural comfort ranges.
            </p>
            <p>
        ...
        {/* SECTION 4 — HOW DEAD ZONE PRICING SHOWS UP */}
        <div className="mb-12">
        ...
        {/* SECTION 5 — WHY SMALL PRICE CUTS DON'T FIX IT */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Price vs Payment in Manteca</h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Small reductions often keep a home inside the dead zone.
            </p>
            <p>
        ...
        {/* SECTION 6 — WHY SELLERS MISREAD THE DEAD ZONE */}
        <div className="mb-12">
        ...
        {/* SECTION 7 — THE CONSEQUENCE OF STAYING IN THE DEAD ZONE */}
        <div className="mb-12">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              The issue isn't whether your price was "reasonable."
            </p>
            <p>
            ...
            <p className="mt-6">
              ...
              {' '}and{' '}
              <Link to="/seller-center/manteca/price-vs-payment" className="text-blue-600 hover:text-blue-700 underline">
                price vs payment in Manteca
              </Link>
