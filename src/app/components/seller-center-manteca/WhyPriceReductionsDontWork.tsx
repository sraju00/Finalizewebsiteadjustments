    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
          Why Manteca Buyers Keep Waiting After Price Cuts (2026)
        </h1>

        {/* STEP 2: Query-matched intro */}
        <div className="text-xl text-gray-600 mb-8">
          <p className="mb-4">
            Sellers in Manteca often ask:<br />
            "Why didn't my home sell?"<br />
            "Are buyers skipping my listing?"<br />
            "Is my price wrong or are buyers just waiting?"
          </p>
          <p>
            This page explains how buyers in Manteca actually make decisions —<br />
        ...
        <div className="bg-gray-100 rounded-lg p-6 mb-8">
          ...
          <p className="text-gray-900 font-medium mb-2">
            Homes in Manteca aren't failing — buyers are recalculating.
          </p>
          ...
          <p className="text-sm text-gray-600">
            This page explains how that buyer behavior plays out in Manteca.
          </p>
        </div>

        <div className="bg-gray-50 rounded-lg p-6 mb-12">
          <p className="text-gray-700 leading-relaxed">
            For example, a Manteca listing can receive strong online views<br />
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Price reductions fail when they don't change buyer perception.
            </p>
            <p>
        ...
        {/* SECTION 2B — WHAT BUYERS ACTUALLY DO */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">How Buyer Skipping Shows Up in Manteca</h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Buyers don't automatically see a price reduction as a green light.
            </p>
        ...
        {/* SECTION 4 — HOW FAILED REDUCTIONS SHOW UP */}
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p className="font-medium text-gray-900 mt-6">
              This creates the reduction spiral.
            </p>
          </div>
        </div>

        {/* SECTION 5 — WHY MULTIPLE REDUCTIONS MAKE IT HARDER */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Repeated Reductions Lose Power</h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Each reduction resets expectations.
            </p>
            <p>
        ...
        {/* SECTION 6 — WHY SELLERS MISREAD PRICE SIGNALS */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Homes Stall Without Feedback</h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Sellers experience price reductions as effort and compromise.
            </p>
            <p>
              Buyers experience them as information.
            </p>
            <p>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p className="text-base text-gray-600 mt-6">
              Price is only one part of that equation.
            </p>
          </div>
        </div>

        {/* SECTION 8 — THE QUESTION SELLERS SHOULD ASK */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">The Question Price Reductions Can't Answer</h2>
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              The question isn't whether you lowered the price enough.
            </p>
            <p>
            ...
            <p className="mt-6">
              Learning about{' '}
              <Link to="/seller-center/manteca/skipping-vs-rejection" className="text-blue-600 hover:text-blue-700 underline">
                skipping vs rejection in Manteca
              </Link>
              {' '}and understanding{' '}
              <Link to="/seller-center-manteca" className="text-blue-600 hover:text-blue-700 underline">
                why homes don't sell in Manteca
              </Link>
