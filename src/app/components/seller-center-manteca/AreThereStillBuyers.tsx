    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
          Are There Still Buyers in Manteca?
        </h1>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Yes — buyers are active in Manteca.<br />
          ...
          <div className="space-y-3 text-gray-700 leading-relaxed">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-3">
                ...
                <span>Compare more options</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gray-400 mt-1">•</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-gray-400 mt-1">•</span>
                <span>Avoid homes that feel risky</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Selective markets feel slow,<br />
              but buyers have not disappeared.
            </p>
            <p>
              Understanding{' '}
              <Link 
                to="/seller-center/manteca/which-price-ranges-moving" 
              ...
              {' '}and what defines a{' '}
              <Link 
                to="/seller-center/manteca/selective-buyer-market" 
                className="text-blue-600 hover:text-blue-700 underline"
              >
