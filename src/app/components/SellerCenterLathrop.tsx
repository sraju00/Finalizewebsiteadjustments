        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Why didn't my home sell in Lathrop?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Most homes in Lathrop don't fail outright. Buyers often hesitate at the monthly payment, compare alternatives, and wait for clearer value before committing."
                }
              },
              {
                "@type": "Question",
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-start">
              ...
              <div className="lg:col-span-3">
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                  Why Homes Don't Sell in Lathrop — Explained Clearly
                </h1>
        ...
        <section id="core-aisles" className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-6">
              {/* Aisle Card 1 */}
              <button 
                onClick={() => navigate('/seller-center/lathrop/why-didnt-my-home-sell')}
              ...
              {/* Aisle Card 2 */}
              <button 
                onClick={() => navigate('/seller-center/lathrop/price-vs-payment')}
                className="bg-white border border-gray-200 rounded-xl p-6 hover:border-gray-400 transition-colors text-left group"
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
              ...
              {/* Aisle Card 4 */}
              <button 
                onClick={() => navigate('/seller-center/lathrop/relist-or-wait')}
                className="bg-white border border-gray-200 rounded-xl p-6 hover:border-gray-400 transition-colors text-left group"
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
