    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
          Why Didn't My Home Sell in Dublin?
        </h1>

        {/* Subhead */}
        <p className="text-xl text-gray-600 mb-12">
          Most homes don't fail. They stall. Here's why that happens in Dublin.
        </p>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              In Dublin, most homes do not fail because buyers are gone.<br />
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Many Dublin buyers are equity-rich move-up buyers.<br />
              Even with strong finances, buyers pause when monthly payments cross comfort thresholds.
            </p>
            ...
            <p>
              ...
              <Link 
                to="/seller-center/dublin/skipping-vs-rejection" 
        ...
        <div className="mb-12">
          ...
          <ul className="space-y-3 text-gray-700 leading-relaxed">
            <li className="flex items-start gap-3">
              ...
              <span>Compare similar homes just below their comfort range</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-gray-400 mt-1">•</span>
              <span>Wait for listings that feel clearly positioned</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-gray-400 mt-1">•</span>
